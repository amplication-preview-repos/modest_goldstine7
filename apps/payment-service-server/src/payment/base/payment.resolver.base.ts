...
export class PaymentResolverBase {
  ...
  async createPayment(
    ...
    return await this.service.createPayment({
      ...
      data: {
        ...
        utilityBill: args.data.utilityBill
          ? {
              connect: args.data.utilityBill,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => UtilityBill, {
    nullable: true,
    name: "utilityBill",
  })
  async getUtilityBill(
    @graphql.Parent() parent: Payment
  ): Promise<UtilityBill | null> {
    const result = await this.service.getUtilityBill(parent.id);
