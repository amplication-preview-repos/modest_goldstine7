...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [ApiIntegration], { name: "apiIntegrations" })
  async findApiIntegrations(
    @graphql.Parent() parent: User,
    @graphql.Args() args: ApiIntegrationFindManyArgs
  ): Promise<ApiIntegration[]> {
    const results = await this.service.findApiIntegrations(parent.id, args);
  ...
  @graphql.ResolveField(() => [UtilityBill], { name: "utilityBills" })
  async findUtilityBills(
    @graphql.Parent() parent: User,
    @graphql.Args() args: UtilityBillFindManyArgs
  ): Promise<UtilityBill[]> {
    const results = await this.service.findUtilityBills(parent.id, args);
